...
#define Kp 2.5
#define Kd 3 // smth 0.4 to 0.9
#define Ki 0

#define leftMotorBaseSpeed 60 //tune
#define rightMotorBaseSpeed 60
...
double weightage[SensorCount] = {180.625, 21.875, -21.875, -180.625}; //change accordinlgly, how much u want it to turn
double error = 0;
double errorSum = 0;
double lastError = 0;
...
void loop()
{
  ...
  {
    leftMotorSpeed = 0-constrain(0-leftMotorSpeed, 0, maxSpeed);
    rightMotorSpeed = constrain(rightMotorSpeed, 0, maxSpeed);
  ...
  {
    leftMotorSpeed = constrain(leftMotorSpeed, 0, maxSpeed);
    rightMotorSpeed = 0-constrain(0-rightMotorSpeed, 0, maxSpeed);
