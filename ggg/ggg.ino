...
#define leftMotorBaseSpeed 55 //tune
#define rightMotorBaseSpeed 55
...
double weightage[SensorCount] = {100, 20, -20, -100}; //change accordinlgly, how much u want it to turn
double error = 0;
double errorSum = 0;
double lastError = 0;
